            ...
            <div className="bg-white p-6 rounded shadow-md w-[90%] h-[90%] flex flex-col">
                <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="flex justify-end items-start">
                        <button
                            onClick={onClose}
                            className="bg-gray-500 text-white px-4 py-2 rounded border-2 border-transparent hover:bg-gray-600 hover:border-gray-600 active:bg-transparent active:text-gray-500 active:border-gray-500"
                        >
                            Close
                        </button>
                    </div>
                        ...
                        {responses.map((response, index) => (
                            <div key={index} className="mb-2 p-2 border border-gray-300 rounded bg-white relative">
                                ...
                                <button
                                    ...
                                    className="absolute top-0 right-0 pb-1 mr-2 mt-2 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center border-2 border-transparent hover:bg-red-600 hover:border-red-600 active:bg-transparent active:text-red-500 active:border-red-500"
                                >
                                    &times;
                                </button>
                            </div>
                            ...
                            insights && (
                                <div className="p-2 border border-gray-300 rounded bg-white relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute top-0 right-0 pb-1 mt-2 mr-2 bg-green-500 text-white rounded-full w-6 h-6 flex items-center justify-center border-2 border-transparent hover:bg-green-600 hover:border-green-600 active:bg-transparent active:text-green-500 active:border-green-500"
                                    >
                                        +
                                    </button>
                                </div>
