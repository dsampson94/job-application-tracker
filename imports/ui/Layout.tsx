            ...
            <aside className="max-w-64 w-64 min-w-64 bg-gray-800 text-white flex flex-col">
                ...
                <div className="p-4">
                    <button
                        ...
                        className="bg-red-500 text-white w-full px-4 py-2 rounded border-2 border-transparent hover:bg-red-400 hover:border-red-400 active:bg-transparent active:text-red-500 active:border-red-500"
                    >
                        Log Out
                    </button>
                </div>
