                                ...
                                <td className="border px-4 py-2 max-w-xs">
                                    <div className="flex items-center justify-center space-x-2">
                                        <button
                                            ...
                                            className="bg-green-500 text-white px-4 py-2 rounded border-2 border-transparent hover:bg-green-600 hover:border-green-600 active:bg-transparent active:text-green-500 active:border-green-500"
                                        >
                                            Insights
                                        </button>
                                        <button
                                            onClick={() => onOpenModal(jobApplication)}
                                            className="bg-yellow-500 text-white px-4 py-2 rounded border-2 border-transparent hover:bg-yellow-600 hover:border-yellow-600 active:bg-transparent active:text-yellow-500 active:border-yellow-500"
                                        >
                                            View
                                        </button>
                                        <button
